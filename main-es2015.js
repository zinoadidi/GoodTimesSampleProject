...
class ApiService {
    ...
    loginUserOnAPI(userLogin) {
        return this.http.post(this.apiURL + 'users/authenticate', userLogin, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => {
            return response['data'];
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(error => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["throwError"])(error);
        }));
    }
    registerUserOnAPI(user) {
        return this.http.post(this.apiURL + 'users/register', user, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => {
            return response['data'];
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(error => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["throwError"])(error);
        }));
    ...
    loadAllUsersFromAPI() {
        return this.http.get(this.apiURL + 'users/', this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => {
            return response['data'];
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(error => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["throwError"])(error);
        }));
...
/* harmony import */ var _goodtimers_goodtimers_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./goodtimers/goodtimers.component */ "./src/app/goodtimers/goodtimers.component.ts");
...
const routes = [
    ...
    { path: 'goodTimers', component: _goodtimers_goodtimers_component__WEBPACK_IMPORTED_MODULE_4__["GoodtimersComponent"] },
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 14, vars: 1, consts: [[1, "w3-top", "w3-indigo", "w3-padding"], ["routerLink", "/profile", 1, "w3-margin", "w3-btn", "w3-padding", "w3-bottombar"], ["routerLink", "/goodTimers", 1, "w3-margin", "w3-btn", "w3-padding", "w3-bottombar"], ["routerLink", "#", 1, "w3-margin", "w3-btn", "w3-padding", "w3-bottombar"], [1, "large-margin-top", "w3-container", "w3-padding", "w3-margin-left"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _goodtimers_goodtimers_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./goodtimers/goodtimers.component */ "./src/app/goodtimers/goodtimers.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"],
        ...
        _goodtimers_goodtimers_component__WEBPACK_IMPORTED_MODULE_8__["GoodtimersComponent"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GoodtimersComponent", function() { return GoodtimersComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
function GoodtimersComponent_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GoodtimersComponent_li_3_Template_button_click_8_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const goodTimer_r1 = ctx.$implicit; const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.showGoodTimerProfile(goodTimer_r1); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "See Profile");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const goodTimer_r1 = ctx.$implicit;
...
class GoodtimersComponent {
    ...
    loadAllUsers() {
        this.apiService.loadAllUsersFromAPI()
            .subscribe((response) => this.handleResponse(response));
    }
    handleResponse(response) {
        this.goodTimers = response;
    }
    showGoodTimerProfile(goodTimer) {
        console.table(goodTimer);
        this.router.navigate(['/profile', goodTimer]);
    }
}
GoodtimersComponent.ɵfac = function GoodtimersComponent_Factory(t) { return new (t || GoodtimersComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
GoodtimersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: GoodtimersComponent, selectors: [["app-goodtimers"]], decls: 4, vars: 1, consts: [[1, "w3-container"], [1, "w3-padding", "w3-margin", 2, "max-width", "800px!important"], [1, "w3-ul"], ["class", "w3-margin", 4, "ngFor", "ngForOf"], [1, "w3-margin"], [1, "w3-padding", "w3-card", "w3-round"], [1, "w3-row"], ["width", "100%", "alt", "profile picture", 1, "w3-col", "w3-round", 2, "height", "", 3, "src"], [1, "w3-col"], [1, "w3-btn", "w3-bar", "w3-round", "w3-indigo", 3, "click"]], template: function GoodtimersComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GoodtimersComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
class LoginComponent {
    ...
    login() {
        this.apiService.loginUserOnAPI(this.user)
            .subscribe((response) => {
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 18, vars: 2, consts: [[1, "w3-margin", "w3-padding"], ["type", "email", 1, "w3-input", 3, "ngModel", "ngModelChange"], ["type", "password", 1, "w3-input", 3, "ngModel", "ngModelChange"], [1, "w3-round", "w3-btn", "w3-bar", "w3-padding", "w3-green", 3, "click"], [1, "w3-round", "w3-btn", "w3-bar", "w3-padding", "w3-indigo", 3, "click"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_16_listener() { return ctx.router.navigate(["/register"]); });
...
ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileComponent, selectors: [["app-profile"]], decls: 38, vars: 11, consts: [[1, "w3-container"], [1, "w3-margin", "w3-padding"], ["width", "120px", "height", "120px", "alt", "profile picture", 3, "src"], [1, "w3-margin", "w3-padding", "w3-table", "w3-striped"], [1, "w3-btn", "w3-bar", "w3-indigo"]], template: function ProfileComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "section", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
class RegisterComponent {
    ...
    register() {
        this.apiService.registerUserOnAPI(this.user)
            .subscribe((response) => {
            this.handleResponse(response);
        });
    }
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 39, vars: 7, consts: [[1, "w3-margin", "w3-padding"], [1, "w3-margin-top"], ["type", "text", "required", "", 1, "w3-input", 3, "ngModel", "ngModelChange"], ["type", "tel", "required", "", 1, "w3-input", 3, "ngModel", "ngModelChange"], ["type", "email", "required", "", 1, "w3-input", 3, "ngModel", "ngModelChange"], ["type", "password", "required", "", 1, "w3-input", 3, "ngModel", "ngModelChange"], [1, "w3-round", "w3-btn", "w3-bar", "w3-padding", "w3-green", 3, "click"], [1, "w3-round", "w3-btn", "w3-bar", "w3-padding", "w3-indigo", 3, "click"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "h1");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "input", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_11_listener($event) { return ctx.user.location = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_15_listener($event) { return ctx.user.phone = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_19_listener($event) { return ctx.user.image = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_textarea_ngModelChange_23_listener($event) { return ctx.user.about = $event; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_28_listener($event) { return ctx.user.email = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_34_listener() { return ctx.register(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_37_listener() { return ctx.router.navigate(["/login"]); });
...
module.exports = __webpack_require__(/*! /Users/zinoadidi/webFiles/GoodTimesAngularProject/src/main.ts */"./src/main.ts");
